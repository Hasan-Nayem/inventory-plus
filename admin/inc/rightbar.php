<div class="br-sideright">
      ...
      <div class="tab-content">
        <div class="tab-pane pos-absolute a-0 mg-t-60 contact-scrollbar active" id="contacts" role="tabpanel">
          <label class="sidebar-label pd-x-25 mg-t-25">Customer Lists</label>
          <div class="contact-list pd-x-10">
            ...
            ?>
            <a href="print.php?id=<?php echo $data['id']; ?>" class="contact-list-link">
              <div class="d-flex">
                ...
                <div class="contact-person">
                  <p class="mg-b-0 "> <?php echo $data['c_name']; ?> </p>
                  <span> <?php echo $data['c_address']; ?> </span>
                </div>
              </div><!-- d-flex -->
            </a>
            <?php } ?>
