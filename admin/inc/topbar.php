        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down"><?php  echo $_SESSION['user_name']; ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                ...
                <h6 class="logged-fullname"><?php  echo $_SESSION['user_name']; ?></h6>
              ...
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="logout.php" onclick='return confirm("Are You Sure Want To Log Out?")'><i class="icon ion-power"></i> Sign Out</a></li>
              </ul>
            </div><!-- dropdown-menu -->
          </div><!-- dropdown -->
        </nav>
